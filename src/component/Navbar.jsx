  ...
  return (
    <nav className="grid grid-cols-2  items-center bg-gray-800 px-24 py-6">
      ...
      <div className="col-start-2 flex justify-end pr-14">
        <Link to="#" className="text-lg px-4 py-2 font-regular">Browse</Link>
        <Link to="/login" className="text-lg px-4 py-2 font-regular">Login</Link>
        <Link to="/register" className="text-lg px-4 py-2 font-regular">Register</Link>
